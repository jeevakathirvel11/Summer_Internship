...
\input{Acid_Base/acid_table}
\input{Acid_Base/base_table}
\newpage
\input{Acid_Base/adduct_table}
%Figures
...
% \begin{figure}[htp]
%     \centering
%     \fbox{\includegraphics[width=16cm, height=7.5cm]{Acid_Base/images/acid_heatmap.png}}
...
% \begin{figure}[htp]
%     \centering
%     \fbox{\includegraphics[width=16cm, height=7.5cm]{Acid_Base/images/base_heatmap.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Acid_Base/images/acid_heatmap.png}}
    \caption{Heatmap with corelation coefficient showing relation between different quantitative variables of Acids}
    \label{fig:Acid_heatmap}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{Acid_Base/images/base_heatmap.png}}
    \caption{Heatmap with corelation coefficient showing relation between different quantitative variables of Bases}
    \label{fig:Base_heatmap}
\end{figure}
